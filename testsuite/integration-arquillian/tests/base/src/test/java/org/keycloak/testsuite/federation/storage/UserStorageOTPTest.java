...
public class UserStorageOTPTest extends AbstractTestRealmKeycloakTest {
    ...
    public void testCredentialsThroughRESTAPI() {
        ...
        List<String> userStorageCredentialTypes = user.getConfiguredUserStorageCredentials();
    ...
    public void testNormalUser() {
        ...
        Assert.assertTrue(userResource.getConfiguredUserStorageCredentials().isEmpty());
