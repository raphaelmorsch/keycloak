...
public class MutualTLSClientTest extends AbstractTestRealmKeycloakTest {
   ...
   @Test
   public void testClientInvocationWithOBBClient_rfc2553() throws Exception {
      testClientInvocationWithOBBClient(X509ClientAuthenticator.SubjectDNFormat.RFC2253, "CN=Foo,JURISDICTIONCOUNTRYNAME=BR,BUSINESSCATEGORY=Business Entity,SERIALNUMBER=2009,OU=My Org Unit,O=Red Hat,L=Boston,ST=MA,C=US");
   }

   @Test
   public void testClientInvocationWithOBBClient_rfc1779() throws Exception {
      testClientInvocationWithOBBClient(X509ClientAuthenticator.SubjectDNFormat.RFC1779, "CN=Foo, JURISDICTIONCOUNTRYNAME=BR, BUSINESSCATEGORY=Business Entity, SERIALNUMBER=2009, OU=My Org Unit, O=Red Hat, L=Boston, ST=MA, C=US");
   }

   @Test
   public void testClientInvocationWithOBBClient_canonical() throws Exception {
      testClientInvocationWithOBBClient(X509ClientAuthenticator.SubjectDNFormat.CANONICAL, "cn=foo,1.3.6.1.4.1.311.60.2.1.3=#13024252,2.5.4.15=#0c0f427573696e65737320456e74697479,2.5.4.5=#130432303039,ou=my org unit,o=red hat,l=boston,st=ma,c=us");
   }

   private void testClientInvocationWithOBBClient(X509ClientAuthenticator.SubjectDNFormat format, String expectedSubjectDN) throws Exception {
      //given
      ...
      config.setTlsClientAuthSubjectDnFormat(format.toString());
