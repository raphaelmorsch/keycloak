...
public class RemoteCacheInitialLoaderContext extends SessionLoader.LoaderContext {
    ...
    public RemoteCacheInitialLoaderContext(int ispnSegmentsCount, int sessionsPerSegment, int sessionsTotal) {
    ...
    public String toString() {
        return new StringBuilder("RemoteCacheInitialLoaderContext [ ")
