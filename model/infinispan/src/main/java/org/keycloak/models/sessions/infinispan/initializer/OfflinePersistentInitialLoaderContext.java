 ...
 */
public class OfflinePersistentInitialLoaderContext extends SessionLoader.InitialLoaderContext {

    private final int sessionsTotal;
    private final int sessionsPerSegment;

    public OfflinePersistentInitialLoaderContext(int sessionsTotal, int sessionsPerSegment) {
    ...
    public String toString() {
        return new StringBuilder("OfflinePersistentInitialLoaderContext [ ")
