...
public class RealmAdapter implements RealmModel, JpaModel<RealmEntity> {
    ...
    @Override
    public WebAuthnPolicy getWebAuthnPolicyStrong() {
        // We will use some prefix for attributes related to strong (passwordless) WebAuthn policy
        return getWebAuthnPolicy(Constants.WEBAUTHN_STRONG_PREFIX);
    }

    @Override
    public void setWebAuthnPolicyStrong(WebAuthnPolicy policy) {
        // We will use some prefix for attributes related to strong (passwordless) WebAuthn policy
        setWebAuthnPolicy(policy, Constants.WEBAUTHN_STRONG_PREFIX);
    }
