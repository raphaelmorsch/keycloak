...
public class DefaultClientTypeManager implements ClientTypeManager {
    ...
    private final Map<String, ClientTypeRepresentation> globalClientTypes;

    public DefaultClientTypeManager(KeycloakSession session, Map<String, ClientTypeRepresentation> globalClientTypes) {
        this.session = session;
        this.globalClientTypes = globalClientTypes;
    }

    @Override
    public Map<String, ClientTypeRepresentation> getClientTypes(RealmModel realm, boolean includeGlobal) {
