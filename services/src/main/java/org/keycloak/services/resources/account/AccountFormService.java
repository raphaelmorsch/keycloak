...
public class AccountFormService extends AbstractSecuredLocalService {
    ...
    @Path("resource/{resource_id}/grant")
    @POST
    public Response grantPermission(@PathParam("resource_id") String resourceId, @FormParam("action") String action, @FormParam("permission_id") List<String> permissionId, @FormParam("requester") String requester, MultivaluedMap<String, String> formData) {
        if (auth == null) {
    ...
    @Path("resource/{resource_id}/share")
    @POST
    public Response shareResource(@PathParam("resource_id") String resourceId, @FormParam("user_id") List<String> userIds, @FormParam("scope_id") List<String> scopes, MultivaluedMap<String, String> formData) {
        if (auth == null) {
            return login("resource");
        }
    ...
    @Path("resource")
    @POST
    public Response processResourceActions(@FormParam("resource_id") List<String> resourceIds, @FormParam("action") String action, MultivaluedMap<String, String> formData) {
        if (auth == null) {
            return login("resource");
        }
