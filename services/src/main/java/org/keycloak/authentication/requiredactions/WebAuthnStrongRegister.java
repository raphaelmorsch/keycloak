...
/**
 * Required action for register WebAuthn strong (passwordless) credential for the user. This class is temporary and will be likely
 * removed in the future during future improvements in authentication SPI
 *
 */
public class WebAuthnStrongRegister extends WebAuthnRegister {

    public WebAuthnStrongRegister(KeycloakSession session, CertPathTrustworthinessValidator certPathtrustValidator) {
    ...
    protected String getCredentialProviderId() {
        return WebAuthnStrongCredentialProviderFactory.PROVIDER_ID;
    }
