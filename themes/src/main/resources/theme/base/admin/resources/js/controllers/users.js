...
module.controller('UserCredentialsCtrl', function($scope, realm, user, $route, $location, RequiredActions, User, UserExecuteActionsEmail,
    ...
    function loadCredentials() {
        ...
        UserCredentials.getConfiguredUserStorageCredentials({ realm: realm.realm, userId: user.id }, null, function(userStorageCredentials) {
            $scope.userStorageCredentials =  userStorageCredentials;
            $scope.hasPassword = userStorageCredentials.lastIndexOf("password") > -1;
        }, function(err) {
