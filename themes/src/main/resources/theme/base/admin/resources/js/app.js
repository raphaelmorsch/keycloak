...
module.config([ '$routeProvider', function($routeProvider) {
    $routeProvider
       ...
       .when('/', {
        ...
        .when('/realms/:realm/authentication/webauthn-policy-strong', {
            templateUrl : resourceUrl + '/partials/webauthn-policy-strong.html',
            resolve : {
                realm : function(RealmLoader) {
                    return RealmLoader();
                },
            ...
            controller : 'RealmWebAuthnStrongPolicyCtrl'
        })
