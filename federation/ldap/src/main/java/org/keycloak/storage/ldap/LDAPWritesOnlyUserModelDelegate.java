...
/**
 * User model delegate, which allows writing just to the LDAP, but not to Keycloak DB.
 *
 * It tracks what attributes were written to LDAP in this transaction. For others, the Read-Only exception is thrown
 *
